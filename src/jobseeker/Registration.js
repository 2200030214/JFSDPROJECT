...
export default function Registration() 
{
  ...
  return (
    <div>
      <h3 align="center"><u>Citizen Registration</u></h3>
      {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label>Contact</label>
          <input type="text" id="contact" value={formData.contact} pattern="[0-9]{10}" title="Please enter 10 digits" onChange={handleChange} required />
        </div>
